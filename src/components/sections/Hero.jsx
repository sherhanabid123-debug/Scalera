            ...
            <div className="hero-content" style={{ maxWidth: '900px', position: 'relative', zIndex: 2, perspective: '1000px' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    <a href="#work" className="hero-btn" style={{
                        background: 'linear-gradient(135deg, var(--accent-orange) 0%, var(--accent-sky) 100%)', color: '#ffffff',
                    ...
                    }} onMouseEnter={(e) => { e.target.style.transform = 'translateY(-4px)'; e.target.style.boxShadow = '0 12px 40px rgba(56, 189, 248, 0.5)'; }}
                        onMouseLeave={(e) => { e.target.style.transform = 'translateY(0)'; e.target.style.boxShadow = '0 8px 32px rgba(249, 115, 22, 0.35)'; }}>
                        View Work
                    </a>
