            ...
            <div className="hero-content" style={{ maxWidth: '900px', position: 'relative', zIndex: 2, perspective: '1000px' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    <a href="#work" className="hero-btn" style={{
                        ...
                        padding: '1.25rem 3rem', borderRadius: '40px', fontWeight: 600,
                        fontSize: '1.05rem', transition: 'all 0.4s cubic-bezier(0.16, 1, 0.3, 1)', display: 'inline-block',
                        boxShadow: '0 8px 32px rgba(59, 130, 246, 0.3)'
                    }} onMouseEnter={(e) => { e.target.style.transform = 'translateY(-4px)'; e.target.style.boxShadow = '0 12px 40px rgba(59, 130, 246, 0.5)'; }}
                        onMouseLeave={(e) => { e.target.style.transform = 'translateY(0)'; e.target.style.boxShadow = '0 8px 32px rgba(59, 130, 246, 0.3)'; }}>
                        View Work
                    </a>
