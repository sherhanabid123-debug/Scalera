...
const CTA = () => {
    ...
    return (
        <section ref={containerRef} className="section" style={{ textAlign: 'center', position: 'relative', overflow: 'hidden', zIndex: 2, background: '#1d1d1f', color: '#ffffff' }}>
            {/* Moving background glow specific to CTA */}
            <div className="cta-glow" style={{
                position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)',
                width: '60vw', height: '60vw', background: 'radial-gradient(circle, rgba(255, 255, 255, 0.05) 0%, rgba(29,29,31,0) 70%)',
            ...
            <div className="container cta-content" style={{ position: 'relative', zIndex: 2 }}>
                ...
                <a
                    ...
                    className="glass"
                    style={{
                        color: '#ffffff', padding: '1.25rem 3.5rem', borderRadius: '40px',
