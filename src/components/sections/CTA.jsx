    ...
    return (
        <section ref={containerRef} className="section" style={{ textAlign: 'center', position: 'relative', overflow: 'hidden', zIndex: 2 }}>
            ...
            <div className="cta-glow" style={{
                ...
                width: '60vw', height: '60vw', background: 'radial-gradient(circle, rgba(28, 28, 28, 0.03) 0%, rgba(252,252,252,0) 70%)',
            ...
            <div className="container cta-content" style={{ position: 'relative', zIndex: 2 }}>
                ...
                <a
                    ...
                    onMouseMove={(e) => {
                        ...
                        e.currentTarget.style.border = '1px solid rgba(28, 28, 28, 0.2)';
                        e.currentTarget.style.boxShadow = '0 15px 40px rgba(28,28,28,0.08)';
                    }}
                    onMouseLeave={(e) => {
                        e.currentTarget.style.transform = 'translate(0px, 0px) scale(1)';
                        e.currentTarget.style.background = ''; // Reverts to CSS class
