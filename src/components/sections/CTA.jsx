    ...
    return (
        <section ref={containerRef} className="section" style={{ textAlign: 'center', position: 'relative', overflow: 'hidden', zIndex: 2 }}>
            ...
            <div className="cta-glow" style={{
                ...
                width: '60vw', height: '60vw', background: 'radial-gradient(circle, rgba(249, 115, 22, 0.1) 0%, rgba(244, 63, 94, 0.05) 35%, transparent 70%)',
            ...
            <div className="container cta-content" style={{ position: 'relative', zIndex: 2 }}>
                ...
                <a
                    ...
                    onMouseMove={(e) => {
                        ...
                        e.currentTarget.style.border = '1px solid rgba(244, 63, 94, 0.3)';
                        e.currentTarget.style.boxShadow = '0 15px 40px rgba(56, 189, 248, 0.2), 0 15px 40px rgba(249, 115, 22, 0.1)';
                    }}
                    onMouseLeave={(e) => {
