                    ...
                    {services.map((service, i) => (
                        <div
                            ...
                            onMouseEnter={(e) => {
                                ...
                                e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.15)'; /* Frost highlight */
                                e.currentTarget.style.boxShadow = '0 20px 40px rgba(0,0,0,0.8), 0 0 40px rgba(255, 255, 255, 0.05)';
                            }}
                            onMouseLeave={(e) => {
